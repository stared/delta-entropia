...
Zatem odpowiednią miarą jest $\log(1/p)$, a owa średnia to:
%
\begin{align}
...
%
\begin{align}
    0.001 \log(1/0.001) + 0.999 \log(1/0.999)
    \approx 0.001 \times 10.00 + 0.999 \times 0.0014
    \approx 0.0100 + 0.0014 = 0.0014,
\end{align}
%
