...
\end{equation}
%
Zatem przy nowym pytaniu pozostanie $p_{tak} n$ albo $p_{nie} n$ obiektów, w zależności od odpowiedzi.
...
Zresztą, pół na pół średnio dostarcza najwięcej informacji --- patrz wykres na marginesie. 
